...
def jsonld(reader, limit):
    ...
    out_str += '''    {
      ...
      "https://schema.org/name": "Molstruct"
    },
    {
      "@id": "#",
      ...
      "https://schema.org/description": "This is a dataset of molecules generated by Molstruct.",
      ...
      "https://schema.org/temporal": "''' + str(datetime.datetime.today().year) + '''",
      "https://schema.org/url": "https://github.com/lszeremeta/molstruct"
    },'''
    for row in reader:
        out_str += '\n    {\n'
...
<html lang="en">
  ...
  <body>
    ...
    for row in reader:
        if n.SUBJECT_BASE:
            print('    <div itemscope itemtype="https://schema.org/MolecularEntity" itemid="' + html.escape(
                n.SUBJECT_BASE + str(
                    i), quote=True), end='')
